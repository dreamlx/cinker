...
<script type="text/javascript">
	...
	function ajaxstatus() {
		if ($("#out_trade_no").val() != 0) {
			$.ajax({
				url : "${pageContext.request.contextPath}/activity/queryOrder?tradeno=" + $("#out_trade_no").val(),
				type :"GET",
				dataType:"json",
				data:"",
				success : function(data) {
					if (data == 1) { //订单状态为1表示支付成功
						window.location.href = "${pageContext.request.contextPath}/activity/orderPaySuccess?tradeno=" +$("#out_trade_no").val();
						return;
					}
				},
				error : function() {
